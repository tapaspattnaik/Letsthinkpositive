...
const MOCK_BY_CATEGORY: Record<string, MockArticle[]> = {
  ...
  environment: [
    ...
    { title: 'Volunteers plant 250 million trees in a single day — a new world record', description: '1.5 million volunteers took part in a coordinated global tree-planting event, smashing the previous record.', url: '#', image: null, source: 'Good News Network', publishedAt: new Date().toISOString() },
  ...
  innovation: [
    { title: 'Teenager\'s invention provides clean water to 10,000 people in rural communities', description: 'A 16-year-old engineer built a solar-powered filtration device using recycled materials.', url: '#', image: null, source: 'BBC News', publishedAt: new Date().toISOString() },
    ...
    { title: 'Vertical farms supply fresh produce to 50,000 families daily', description: 'Urban agriculture startups are transforming city rooftops into high-yield food systems.', url: '#', image: null, source: 'Bloomberg Green', publishedAt: new Date().toISOString() },
  ...
  people: [
    ...
    { title: 'Single father cycles 5,000 km to raise funds for his son\'s surgery', description: 'A 38-year-old mechanic with no cycling experience completed a coast-to-coast ride in 47 days.', url: '#', image: null, source: 'Reuters', publishedAt: new Date().toISOString() },
    { title: 'Street artist transforms crumbling city walls into murals celebrating local heroes', description: 'Over three years, one artist has painted 120 murals featuring nurses, sanitation workers, and teachers.', url: '#', image: null, source: 'Good News Network', publishedAt: new Date().toISOString() },
    { title: 'Community celebrates teacher who spent 40 years never missing a single day', description: 'The beloved teacher retired last month with a perfect attendance record spanning four decades.', url: '#', image: null, source: 'Local News', publishedAt: new Date().toISOString() },
  ],
}
